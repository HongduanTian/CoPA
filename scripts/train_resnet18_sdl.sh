...
function train_fn {
    CUDA_VISIBLE_DEVICES=<gpu_id> python train_net.py --seed=42 --model.dir ./saved_results/ --model.name=$1 --data.train $2 --data.val $2 --data.test $2 --train.batch_size=$3 --train.learning_rate=$4 --train.max_iter=$5 --train.cosine_anneal_freq=$6 --train.eval_freq=$6
}
